...
/* async class, takes a string, and return a photo list */
...
class GetFlickrJsonData(private val listener: OnDataAvailable): AsyncTask<String, Void, ArrayList<Photo>>(){
    ...
    override fun doInBackground(vararg params: String?): ArrayList<Photo> {
        ...
        try{
            ...
            //retrieving json value one by one, and putting in the string value we need
            for(i in 0 until itemsArray.length()){
                ...
                val link = photoUrl.replaceFirst("_m.jpg","_b.jpg") //provide url of fullsize picture
    ...
    //without question mark means non nullable
